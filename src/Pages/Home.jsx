...
export default function Home() {
  ...
  useEffect(() => {
    fetch("https://node-backend-vercel-e7zklcubw-pramodkumar0.vercel.app/latest")
    .then((res) => res.json()).then((json) => setLatest(json));
  }, []);

  useEffect(() => {
    fetch("https://node-backend-vercel-e7zklcubw-pramodkumar0.vercel.app/latestArticle")
    .then((res) => res.json()).then((json) => setLatestArticle(json));
  }, []);

  useEffect(() => {
    fetch("https://node-backend-vercel-e7zklcubw-pramodkumar0.vercel.app/smText")
    .then((res) => res.json()).then((json) => setsmImg(json));
  }, []);

  useEffect(() => {
    fetch("https://node-backend-vercel-e7zklcubw-pramodkumar0.vercel.app/lgText")
